...
import org.pablocastillo.dto.ProductoDTO;
...
public class FormProductosController implements Initializable {
    ...
    public void agregarProducto(){
        try{
            ...
            statement.setInt(9,((CategoriaP)cmbCategoriasP.getSelectionModel().getSelectedItem()).getCategoriaproductosId());
            statement.execute();
        }catch(Exception e){
    ...
    public void editarProducto(){
        try{
            ...
            statement.setInt(10,((CategoriaP)cmbCategoriasP.getSelectionModel().getSelectedItem()).getCategoriaproductosId());
            statement.execute();
        }catch(Exception e){
            System.out.println(e.getMessage());
        }finally{
